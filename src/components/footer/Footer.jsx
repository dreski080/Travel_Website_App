    ...
    <Container disableGutters maxWidth= 'xl' sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <img src={instagramIcon} style={{cursor: 'pointer'}} />
        </Box>
      </Box>
            ...
            footerNav.map(item => (
              <Box key={item.id}>
                ...
                <Box sx={{
                  ...
                  {
                    item.links.map(link => (
                      <Link key={link} href="#" underline="none" color='#5b5b5b' sx={{
                        width: 'fit-content',
                        fontWeight: '400',
                        fontSize: '13px',
                        '&:hover': {
      ...
      maxWidth: {
        ...
        <Box sx={{
          ...
          <Box>
            <img src={inputIcon} style={{ position: 'absolute', left: '16px', top: '36px', transform: 'translateY(-50%)'}} />
